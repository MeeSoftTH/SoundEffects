...
class InterfaceController2: WKInterfaceController {
    ...
    let ActionSound1 = NSBundle.mainBundle().URLForResource("baby5", withExtension: "mp3")!
    let ActionSound2 = NSBundle.mainBundle().URLForResource("baby6", withExtension: "mp3")!
    let ActionSound3 = NSBundle.mainBundle().URLForResource("baby7", withExtension: "mp3")!
    let ActionSound4 = NSBundle.mainBundle().URLForResource("baby8", withExtension: "mp3")!
